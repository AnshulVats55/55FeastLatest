        ...
        <Box className={classes.getMainContStyles}>
            ...
            <form onSubmit={handleSubmit(handleSignup)} className={classes.getSignupFormStyles}>
                <Grid container rowSpacing={2} columnSpacing={1}>
                    ...
                    <Grid item lg={6} md={6} sm={12} xs={12} sx={{display:"flex", justifyContent:"flex-start", alignItems:"center",}}>
                        <motion.div
                            initial={{ scale: 1 }}
                            whileTap={{ scale: 0.97 }}
                    ...
                    </Grid>
                    {
                        ...
                        <CustomDialog
                            ...
                            handleImageReselection={handleImageReselection}
            ...
            <Box className={classes.getLinkContStyles}>
                <Typography className={classes.getActionTextOneStyles}>Already have an account?</Typography>
                <Link
                    to="/"
